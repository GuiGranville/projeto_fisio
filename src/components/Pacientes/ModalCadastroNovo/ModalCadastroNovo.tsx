...
export function ModalCadastroNovo(props: props) {
    ...
    function cancelar() {
        props.setModalCadastrarNovo(false)
        props.setCadastroPaciente(PacienteEstadoInicial)
    }
                ...
                <div className="modalCadastroNovo-content">
                    <div className="modalCadastroNovo-dadosPessoais">
                        ...
                        <div>
                            ...
                            <SelectWithTitle name="estado_civil"  value={props.cadastroPaciente.estado_civil} fnEdit={(e) => handleChange(e)} listaItens={estadoCivil} title="Estado Civil*" inputHeight="3.5rem" wrapperWidth="40%" />
                        ...
                        <div>
                            <InputWithTitle name="numero_telefone" value={props.cadastroPaciente.numero_telefone} fnEdit={(e) => handleChange(e)} title="Celular*" inputHeight="3.5rem" wrapperWidth="25%" />
                            <InputWithTitle name="telefone_fixo" value={props.cadastroPaciente.telefone_fixo} fnEdit={(e) => handleChange(e)} title="Telefone Fixo" inputHeight="3.5rem" wrapperWidth="25%" />
                            <InputWithTitle name="email" value={props.cadastroPaciente.email} fnEdit={(e) => handleChange(e)} title="Email" inputHeight="3.5rem" wrapperWidth="25%" />
                            <SelectWithTitle name="preferencia_contato" value={props.cadastroPaciente.preferencia_contato} fnEdit={(e) => handleChange(e)} listaItens={preferenciaContato} title="Preferência de Contato" inputHeight="3.5rem" wrapperWidth="25%" />
                        </div>
                        <div>
                            <SelectWithTitle name="cd_convenio" value={props.cadastroPaciente.cd_convenio} fnEdit={(e) => handleChange(e)} title="Convênio" inputHeight="3.5rem" wrapperWidth="25%" />
                            <InputWithTitle name="numero_convenio" value={props.cadastroPaciente.numero_convenio} fnEdit={(e) => handleChange(e)} title="Número do Convênio" inputHeight="3.5rem" wrapperWidth="25%" />
                            <InputWithTitle name="validade_carteirinha" value={props.cadastroPaciente.validade_carteirinha} fnEdit={(e) => handleChange(e)} type="date" title="Validade da Carteirinha" placeholder="__/__/____" inputHeight="3.5rem" wrapperWidth="25%" />
                            <InputWithTitle name="numero_cns" value={props.cadastroPaciente.numero_cns} fnEdit={(e) => handleChange(e)} title="Número no CNS" inputHeight="3.5rem" wrapperWidth="25%" />
                        </div>
                    </div>
                    <div className="modalCadastroNovo-dadosEndereco">
                        ...
                        <div>
                            <SelectWithTitle name="nm_pais" fnEdit={(e) => handleChange(e)} title="País" inputHeight="3.5rem" wrapperWidth="25%" />
                            <InputWithTitle name="cep" fnEdit={(e) => handleChange(e)} title="CEP" inputHeight="3.5rem" wrapperWidth="25%" />
                            <InputWithTitle name="nm_estado" fnEdit={(e) => handleChange(e)} title="Estado" inputHeight="3.5rem" wrapperWidth="25%" />
                            <InputWithTitle name="nm_cidade" fnEdit={(e) => handleChange(e)} title="Cidade" inputHeight="3.5rem" wrapperWidth="25%" />
                        </div>
                        <div>
                            <InputWithTitle name="logradouro" fnEdit={(e) => handleChange(e)} title="Logradouro" inputHeight="3.5rem" wrapperWidth="25%" />
                            <InputWithTitle name="numero_casa" fnEdit={(e) => handleChange(e)} title="Número" inputHeight="3.5rem" wrapperWidth="25%" />
                            <InputWithTitle name="nm_bairro" fnEdit={(e) => handleChange(e)} title="Bairro" inputHeight="3.5rem" wrapperWidth="25%" />
                            <InputWithTitle name="complemento" fnEdit={(e) => handleChange(e)} title="Complemento" inputHeight="3.5rem" wrapperWidth="25%" />
                        </div>
